...
const TABS = [
  {
    ...
    href: "/",
    icon: (active: boolean) => (
      <svg width="24" height="24" viewBox="0 0 32 32" fill={active ? "#007AFF" : "#8e8e93"}>
  ...
  },
  {
    ...
    href: "/calls",
    icon: (active: boolean) => (
      <svg width="24" height="24" viewBox="0 0 24 24" fill={active ? "#007AFF" : "#8e8e93"}>
  ...
  },
  {
    ...
    href: "/stories",
    icon: (active: boolean) => (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={active ? "#007AFF" : "#8e8e93"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
